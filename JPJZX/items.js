...
const ITEMS_DATABASE = {
    ...
    green: [
        ...
        // 更多绿色物品
        { id: 'g_1', name: '生锈链条', icon: '⛓️', quality: 'green', baseValue: 100, width: 1, height: 1, category: 'material' },
        { id: 'g_2', name: '旧报纸', icon: '📰', quality: 'green', baseValue: 60, width: 1, height: 1, category: 'material' },
        { id: 'g_3', name: '破布', icon: '🧹', quality: 'green', baseValue: 50, width: 1, height: 1, category: 'material' },
        { id: 'g_4', name: '空瓶子', icon: '🍾', quality: 'green', baseValue: 70, width: 1, height: 1, category: 'material' },
        { id: 'g_5', name: '旧鞋子', icon: '👞', quality: 'green', baseValue: 80, width: 2, height: 1, category: 'material' },
        { id: 'g_6', name: '破雨伞', icon: '☂️', quality: 'green', baseValue: 90, width: 1, height: 2, category: 'material' },
        { id: 'g_7', name: '旧钥匙', icon: '🔑', quality: 'green', baseValue: 110, width: 1, height: 1, category: 'valuable' },
        { id: 'g_8', name: '打火机', icon: '🔥', quality: 'green', baseValue: 100, width: 1, height: 1, category: 'material' },
        { id: 'g_9', name: '手电筒', icon: '🔦', quality: 'green', baseValue: 130, width: 1, height: 2, category: 'electronic' },
        { id: 'g_10', name: '绳索', icon: '🪢', quality: 'green', baseValue: 120, width: 1, height: 1, category: 'material' }
    ],
